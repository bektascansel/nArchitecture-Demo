...
using Application.Features.Models.Queries.GetByListByDynamic;
...
namespace WebApi.Controllers
{
    ...
    public class ModelsController : BaseController
    {
        ...
        public async Task<IActionResult> GetListByDnamic([FromQuery] PageRequest pageRequest, [FromBody] DynamicQuery? dynamicQuery=null)
        {
